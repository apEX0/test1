 ...
 * 
 */
@WebServiceClient(name = "DailyInfo", targetNamespace = "http://web.cbr.ru/", wsdlLocation = "file:/C:/Users/vsgor/IdeaProjects/test1/DailyInfo.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Users/vsgor/IdeaProjects/test1/DailyInfo.xml");
